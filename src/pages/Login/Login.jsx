                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
                        <form class="w-full max-w-md">
                            ...
                            <h1 class="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">Login</h1>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-6 text-center ">
                                    <Link to={'/sign-up'} class="text-sm text-blue-500 hover:underline dark:text-blue-400">
